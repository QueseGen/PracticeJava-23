...
public class App {
    ...
    public static void main(String[] args) {
        ...
        User currentUser= new User(); //User testUser= new User("Elon", "Musky", false);
       
        System.out.printf("\n--------------Welcome to PopShop--------------\nPlease Login. \n\n\tUsername: ");
        Scanner scannerTest = new Scanner(System.in);
        
        currentUser.setUsername(scannerTest.nextLine()); 
        System.out.printf("\tPassword: ");
        currentUser.setPassword(scannerTest.nextLine());
